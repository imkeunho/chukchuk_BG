    ...
    return (
        <div className={`fixed top-0 left-0 z-[1055] flex h-full w-full justify-center bg-black bg-opacity-20`}>
            <div
                ...
                <div className="justify-center bg-warning-400 mt-6 mb-6 text-lg border-b-4 border-gray-500">
                    {title}
                </div>
                <div className="text-base border-orange-400 border-b-4 pb-4">
                    {content}
                </div>
                <div className="justify-end flex ">
                    <button className="rounded bg-blue-500 mt-4 mb-4 px-6 pt-2 pb-2 text-base text-white"
                            onClick={() => {
                                if (callbackFn) {
                                    callbackFn();
                                }
